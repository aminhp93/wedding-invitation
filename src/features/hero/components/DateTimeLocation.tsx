...
export const DateTimeLocation = ({
  ...
  return (
    <section className="py-24 bg-[#FFF9F6] relative overflow-hidden">
      ...
      >
        <div>
          <p className="text-xl md:text-2xl font-serif text-[#A03D1A] italic mb-6">
            {timeLine}
          </p>
          <div className="flex justify-center items-center gap-6 md:gap-10">
            <span className="text-4xl md:text-6xl font-serif text-[#A03D1A] font-light">
              {day}
            </span>
          ...
          {lunarDate && (
            <p className="text-stone-500 font-serif italic text-sm mt-4">
              {lunarDate}
            </p>
          )}
        </div>
        ...
        <div className="space-y-4">
          <p className="text-lg md:text-xl font-serif text-[#A03D1A] italic tracking-tight uppercase">
            {locationName}
          </p>
